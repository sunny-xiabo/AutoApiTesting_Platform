...
TestData = CaseData(ConfigHandler.data_path + r'CLTEmissionScource/clt_add_emissionSourceProject.yaml').case_process()
re_data = regular(str(TestData))


@allure.epic("Carbon Lens TEC")
@allure.feature("排放源管理模块")
class TestCltAddEmissionsourceproject:
...
if __name__ == '__main__':
    pytest.main(['test_clt_add_emissionSourceProject.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
